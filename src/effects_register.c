...
const struct pk_underglow_effect_ops pk_underglow_effects[] = {
    ...
    {.name = "Ripple", .render = zmk_pk_underglow_effect_ripple, .pos_changed = zmk_pk_underglow_effect_ripple_trigger, .is_animated = true},
    {.name = "Ripple Disco",
     ...
     .is_animated = true},
    {.name = "Twinkle", .render = zmk_pk_underglow_effect_twinkle, .select = zmk_pk_underglow_effect_twinkle_select, .is_animated = true},
    {.name = "Twinkle Disco",
