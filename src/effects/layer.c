 ...
 * will consume significant CPU time. While the raw power consumption of the LEDs 
 * themselves will generally dwarf the MCU's energy usage, this constant polling 
 * prevents the processor from entering deeper idle states. Animated layer effects 
