 ...
 * 
 * Visual Description:
 * Simulates a starry night sky. Individual LEDs randomly light up (twinkle) and then slowly fade back into a dimmer background state.
 * Creates a subtle, sparkling appearance across the keyboard. Can be configured to use a single hue or a rainbow of colors.
 */
