...
#define DT_DRV_COMPAT zmk_behavior_pk_underglow_indicators
...
static int underglow_indicators_process(struct zmk_behavior_binding *binding, struct zmk_behavior_binding_event event) {
...
#define KP_INST(n)                                                                                                     \
    static struct underglow_indicators_config underglow_indicators_config_##n = {.indicator =                          \
