...
static int underglow_eff_usb_process(struct zmk_behavior_binding *binding, struct zmk_behavior_binding_event event) {
...
BEHAVIOR_DT_INST_DEFINE(0, underglow_eff_usb_init, NULL, NULL, NULL, POST_KERNEL, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT,
                        &underglow_eff_usb_driver_api);
